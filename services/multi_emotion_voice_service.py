...
class MultiEmotionVoiceService:
    ...
    def get_multi_emotion_voice_by_voice_id_emotion_id_strength_id(self, voice_id: int, emotion_id: int, strength_id: int) -> \
    Optional[MultiEmotionVoiceEntity]:
        """根据voice_id,emotion_id,strength_id查询多情绪音色变体"""
    ...
    def get_multi_emotion_voice_by_voice_id(self, voice_id: int) -> Optional[list[MultiEmotionVoiceEntity]]:
    ...
    def get_multi_emotion_voice_by_id(self, multi_emotion_voice_id: int) -> Optional[MultiEmotionVoiceEntity]:
        """根据 ID 获取多情绪音色变体"""
